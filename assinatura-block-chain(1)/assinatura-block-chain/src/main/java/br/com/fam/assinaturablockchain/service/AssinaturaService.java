...
import static br.com.fam.assinaturablockchain.service.BlockchainService.gerarHash;
...
public class AssinaturaService {
	...
	public AssinaturaVO salvarAssinatura(AssinaturaVO assinaturaCadastrar) {
		...
		assinaturaEntity.setHash(gerarHash(assinaturaCadastrar));
	...
	public AssinaturaVO alerarAssinatura(AssinaturaVO assinaturaAlterar) {
		...
		AssinaturaEntity assinaturaEntity = assinaturaRepository.findById(assinaturaAlterar.getIdAssinatura())
				.orElseThrow(() -> new NaoEncontradoException(NAO_ENCONTRADO + assinaturaAlterar.getIdAssinatura()));
	...
	private AssinaturaVO alterar(AssinaturaEntity assinaturaEntity, AssinaturaVO assinaturaAlterarVO) {
		...
		assinaturaEntity.setContent(assinaturaAlterarVO.getContent());
		assinaturaEntity.setHash(assinaturaAlterarVO.getHash());
	...
	private AssinaturaVO converterEntityParaAssinaturaVO(AssinaturaEntity assinaturaEntity) {
		...
		assinaturaVO.setContent(assinaturaEntity.getContent());
		assinaturaVO.setHash(assinaturaEntity.getHash());
		return assinaturaVO;
	}
